...
(0, _ava2.default)('foo', t => {
    ...
    var x = 3;
    t.is(_rec._expr(_rec._capt(x, 'arguments/0'), {
        content: 't.is(x, 3)',
        filepath: 'Test.js',
        line: 8,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"is","range":[2,4]},"computed":false,"range":[0,4]},"arguments":[{"type":"Identifier","name":"x","range":[5,6]},{"type":"NumericLiteral","value":3,"range":[8,9]}],"range":[0,10]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"is","range":[2,4]},{"type":{"label":"("},"range":[4,5]},{"type":{"label":"name"},"value":"x","range":[5,6]},{"type":{"label":","},"range":[6,7]},{"type":{"label":"num"},"value":3,"range":[8,9]},{"type":{"label":")"},"range":[9,10]}]',
        visitorKeys: _powerAssertVisitorKeys
    }), 3);
});

(0, _ava2.default)('bar', t => {
    var _rec2 = new _powerAssertRecorder();

    var y = 5;

    t.is(_rec2._expr(_rec2._capt(y, 'arguments/0'), {
        content: 't.is(y, 6)',
        filepath: 'Test.js',
        line: 14,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"is","range":[2,4]},"computed":false,"range":[0,4]},"arguments":[{"type":"Identifier","name":"y","range":[5,6]},{"type":"NumericLiteral","value":6,"range":[8,9]}],"range":[0,10]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"is","range":[2,4]},{"type":{"label":"("},"range":[4,5]},{"type":{"label":"name"},"value":"y","range":[5,6]},{"type":{"label":","},"range":[6,7]},{"type":{"label":"num"},"value":6,"range":[8,9]},{"type":{"label":")"},"range":[9,10]}]',
        visitorKeys: _powerAssertVisitorKeys
    }), 6);
});
//# sourceMappingURL=node_modules/.cache/ava/42e6bc4d6bc90190f3da60c5b8838eb3.js.map