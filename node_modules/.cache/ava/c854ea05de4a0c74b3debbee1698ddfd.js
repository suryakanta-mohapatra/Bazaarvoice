...
(0, _ava2.default)('foo', t => {
    ...
    var Test = java.import('ABC');
    var test = new Test();

    //  var instance = java.newInstanceSync("ABC");

    var result = java.callMethodSync(test, "add", 42, 4);
    t.is(_rec._expr(_rec._capt(result, 'arguments/0'), {
        content: 't.is(result, 46)',
        filepath: 'Test.js',
        line: 15,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"is","range":[2,4]},"computed":false,"range":[0,4]},"arguments":[{"type":"Identifier","name":"result","range":[5,11]},{"type":"NumericLiteral","value":46,"range":[13,15]}],"range":[0,16]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"is","range":[2,4]},{"type":{"label":"("},"range":[4,5]},{"type":{"label":"name"},"value":"result","range":[5,11]},{"type":{"label":","},"range":[11,12]},{"type":{"label":"num"},"value":46,"range":[13,15]},{"type":{"label":")"},"range":[15,16]}]',
        visitorKeys: _powerAssertVisitorKeys
    }), 46);
    /*java.callMethodSync(instance, "add", 42, 4, function(err, results) {
    ...
    /*
        ...
        var instance = java.newInstanceSync("ABC");
        instance.add(3,3,function(err, results) {
            if(err) { console.error(err); return; }
            t.is(results,7);
        });*/
});
//# sourceMappingURL=node_modules/.cache/ava/c854ea05de4a0c74b3debbee1698ddfd.js.map