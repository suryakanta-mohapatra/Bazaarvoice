...
(0, _ava2.default)('foo', t => {
    ...
    var result = java.callMethod(main, "searchResults", "text", "sample");
    t.is(_rec._expr(_rec._capt(result, "arguments/0"), {
        content: "t.is(result, 4)",
        filepath: "Test.js",
        line: 16,
        ast: "{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"t\",\"range\":[0,1]},\"property\":{\"type\":\"Identifier\",\"name\":\"is\",\"range\":[2,4]},\"computed\":false,\"range\":[0,4]},\"arguments\":[{\"type\":\"Identifier\",\"name\":\"result\",\"range\":[5,11]},{\"type\":\"NumericLiteral\",\"value\":4,\"range\":[13,14]}],\"range\":[0,15]}",
        tokens: "[{\"type\":{\"label\":\"name\"},\"value\":\"t\",\"range\":[0,1]},{\"type\":{\"label\":\".\"},\"range\":[1,2]},{\"type\":{\"label\":\"name\"},\"value\":\"is\",\"range\":[2,4]},{\"type\":{\"label\":\"(\"},\"range\":[4,5]},{\"type\":{\"label\":\"name\"},\"value\":\"result\",\"range\":[5,11]},{\"type\":{\"label\":\",\"},\"range\":[11,12]},{\"type\":{\"label\":\"num\"},\"value\":4,\"range\":[13,14]},{\"type\":{\"label\":\")\"},\"range\":[14,15]}]",
        visitorKeys: _powerAssertVisitorKeys
    }), 4);
});

(0, _ava2.default)('Soo', t => {
    var _rec2 = new _powerAssertRecorder();

    var result2 = java.callMethod(main, "searchResults", "text", "sample");
    t.is(_rec2._expr(_rec2._capt(result2, "arguments/0"), {
        content: "t.is(result2, 3)",
        filepath: "Test.js",
        line: 22,
        ast: "{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"t\",\"range\":[0,1]},\"property\":{\"type\":\"Identifier\",\"name\":\"is\",\"range\":[2,4]},\"computed\":false,\"range\":[0,4]},\"arguments\":[{\"type\":\"Identifier\",\"name\":\"result2\",\"range\":[5,12]},{\"type\":\"NumericLiteral\",\"value\":3,\"range\":[14,15]}],\"range\":[0,16]}",
        tokens: "[{\"type\":{\"label\":\"name\"},\"value\":\"t\",\"range\":[0,1]},{\"type\":{\"label\":\".\"},\"range\":[1,2]},{\"type\":{\"label\":\"name\"},\"value\":\"is\",\"range\":[2,4]},{\"type\":{\"label\":\"(\"},\"range\":[4,5]},{\"type\":{\"label\":\"name\"},\"value\":\"result2\",\"range\":[5,12]},{\"type\":{\"label\":\",\"},\"range\":[12,13]},{\"type\":{\"label\":\"num\"},\"value\":3,\"range\":[14,15]},{\"type\":{\"label\":\")\"},\"range\":[15,16]}]",
        visitorKeys: _powerAssertVisitorKeys
    }), 3);
});
//# sourceMappingURL=node_modules/.cache/ava/7cc2da7e6c0652daab7abb3b6b7f552a.js.map