...
_ava2.default.serial('foo', t => {
    ...
    java.callMethod(main, "searchResults", "text", "sample", function (err, result) {
        ...
        t.is(_rec._expr(_rec._capt(result, 'arguments/0'), {
            content: 't.is(result, 2)',
            filepath: 'Test.js',
            line: 17,
            ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"is","range":[2,4]},"computed":false,"range":[0,4]},"arguments":[{"type":"Identifier","name":"result","range":[5,11]},{"type":"NumericLiteral","value":2,"range":[13,14]}],"range":[0,15]}',
            tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"is","range":[2,4]},{"type":{"label":"("},"range":[4,5]},{"type":{"label":"name"},"value":"result","range":[5,11]},{"type":{"label":","},"range":[11,12]},{"type":{"label":"num"},"value":2,"range":[13,14]},{"type":{"label":")"},"range":[14,15]}]',
            visitorKeys: _powerAssertVisitorKeys
        }), 2);
    });
});
//# sourceMappingURL=node_modules/.cache/ava/2326335757254e1ed280f1ff430dcd7e.js.map