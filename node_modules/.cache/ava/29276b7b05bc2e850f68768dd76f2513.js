...
(0, _ava2.default)('foo', t => {
    ...
    java.callMethodSync(instance, "add", 3, 3, function (err, results) {
        var _rec = new _powerAssertRecorder();

        if (err) {
            console.error(err);return;
        }
        t.is(_rec._expr(_rec._capt(results, 'arguments/0'), {
            content: 't.is(results, 6)',
            filepath: 'Test.js',
            line: 12,
            ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"is","range":[2,4]},"computed":false,"range":[0,4]},"arguments":[{"type":"Identifier","name":"results","range":[5,12]},{"type":"NumericLiteral","value":6,"range":[14,15]}],"range":[0,16]}',
            tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"is","range":[2,4]},{"type":{"label":"("},"range":[4,5]},{"type":{"label":"name"},"value":"results","range":[5,12]},{"type":{"label":","},"range":[12,13]},{"type":{"label":"num"},"value":6,"range":[14,15]},{"type":{"label":")"},"range":[15,16]}]',
            visitorKeys: _powerAssertVisitorKeys
        }), 6);
    });
});
//# sourceMappingURL=node_modules/.cache/ava/29276b7b05bc2e850f68768dd76f2513.js.map