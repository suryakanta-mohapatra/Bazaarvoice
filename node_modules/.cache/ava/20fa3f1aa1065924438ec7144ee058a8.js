...
(0, _ava2.default)('foo', t => {
    ...
    t.is(_rec._expr(_rec._capt(_rec._capt(list1, 'arguments/0/callee/object').size(), 'arguments/0'), {
        content: 't.is(list1.size(), 1)',
        filepath: 'Test.js',
        line: 14,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"is","range":[2,4]},"computed":false,"range":[0,4]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"list1","range":[5,10]},"property":{"type":"Identifier","name":"size","range":[11,15]},"computed":false,"range":[5,15]},"arguments":[],"range":[5,17]},{"type":"NumericLiteral","value":1,"range":[19,20]}],"range":[0,21]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"is","range":[2,4]},{"type":{"label":"("},"range":[4,5]},{"type":{"label":"name"},"value":"list1","range":[5,10]},{"type":{"label":"."},"range":[10,11]},{"type":{"label":"name"},"value":"size","range":[11,15]},{"type":{"label":"("},"range":[15,16]},{"type":{"label":")"},"range":[16,17]},{"type":{"label":","},"range":[17,18]},{"type":{"label":"num"},"value":1,"range":[19,20]},{"type":{"label":")"},"range":[20,21]}]',
        visitorKeys: _powerAssertVisitorKeys
    }), 1);
});
//# sourceMappingURL=node_modules/.cache/ava/20fa3f1aa1065924438ec7144ee058a8.js.map