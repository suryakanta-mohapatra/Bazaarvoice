...
(0, _ava2.default)('foo', t => {
    ...
    t.is(_rec._expr(_rec._capt(result, 'arguments/0'), {
        content: 't.is(result, 47)',
        filepath: 'Test.js',
        line: 12,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"is","range":[2,4]},"computed":false,"range":[0,4]},"arguments":[{"type":"Identifier","name":"result","range":[5,11]},{"type":"NumericLiteral","value":47,"range":[13,15]}],"range":[0,16]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"is","range":[2,4]},{"type":{"label":"("},"range":[4,5]},{"type":{"label":"name"},"value":"result","range":[5,11]},{"type":{"label":","},"range":[11,12]},{"type":{"label":"num"},"value":47,"range":[13,15]},{"type":{"label":")"},"range":[15,16]}]',
        visitorKeys: _powerAssertVisitorKeys
    }), 47);
});
//# sourceMappingURL=node_modules/.cache/ava/d476629631b522294917fb520e568b25.js.map