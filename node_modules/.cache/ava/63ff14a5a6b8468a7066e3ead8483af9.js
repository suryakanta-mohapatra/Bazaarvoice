...
(0, _ava2.default)('foo', t => {
    ...
    java.callMethodSync(instance, "add", 3, 3, function (err, results) {
        ...
        t.is(_rec._expr(_rec._capt(results, 'arguments/0'), {
            content: 't.is(results, 7)',
            filepath: 'Test.js',
            line: 12,
            ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"is","range":[2,4]},"computed":false,"range":[0,4]},"arguments":[{"type":"Identifier","name":"results","range":[5,12]},{"type":"NumericLiteral","value":7,"range":[14,15]}],"range":[0,16]}',
            tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"is","range":[2,4]},{"type":{"label":"("},"range":[4,5]},{"type":{"label":"name"},"value":"results","range":[5,12]},{"type":{"label":","},"range":[12,13]},{"type":{"label":"num"},"value":7,"range":[14,15]},{"type":{"label":")"},"range":[15,16]}]',
            visitorKeys: _powerAssertVisitorKeys
        }), 7);
    });
});
//# sourceMappingURL=node_modules/.cache/ava/63ff14a5a6b8468a7066e3ead8483af9.js.map